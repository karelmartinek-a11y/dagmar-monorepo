...
import type { AdminUser, IntegrationClient } from "../api/types";
...
export function AdminOverviewPage(){
  ...
  const integrations=useQuery({queryKey:["integrations"],queryFn:()=>api.admin<IntegrationClient[]>("/api/v1/admin/integrations/clients")});
