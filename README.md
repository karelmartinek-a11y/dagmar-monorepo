...
- zaměstnanec i admin vybírají ve zvoleném měsíci jen úvazky platné podle `start_date`/`end_date` u aktivních uživatelů s překryvem období; docházka a plán mají samostatné zámky
