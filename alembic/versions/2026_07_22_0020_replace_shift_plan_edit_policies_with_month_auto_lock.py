"""Replace shift plan edit policies with month auto-lock tracking.

Revision ID: 2026_07_22_0020
Revises: 2026_07_18_0019
...
revision = "2026_07_22_0020"
down_revision = "2026_07_18_0019"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        "shift_plan_auto_lock_runs",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("year", sa.Integer(), nullable=False),
        sa.Column("month", sa.Integer(), nullable=False),
        sa.Column("executed_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("locked_count", sa.Integer(), server_default="0", nullable=False),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("year", "month", name="uq_shift_plan_auto_lock_run_month"),
    )
    op.create_index(
        "ix_shift_plan_auto_lock_runs_year_month",
        "shift_plan_auto_lock_runs",
        ["year", "month"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index("ix_shift_plan_auto_lock_runs_year_month", table_name="shift_plan_auto_lock_runs")
    op.drop_table("shift_plan_auto_lock_runs")
