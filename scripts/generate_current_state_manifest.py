...
FRONTEND_COMPONENTS = {
    ...
    "/admin/skupiny-uvazku": "web/src/pages/AdminEmploymentGroupsPage.tsx",
        ...
        "frontend_backend_bindings": [
            {
                ...
                "backend_endpoints": [
                    ...
                    "/api/v1/shift-plan/groups",
                    "/api/v1/shift-plan/groups/{group_id}",
            ...
            },
            {
                ...
                "backend_endpoints": [
                    ...
                    "/api/v1/admin/attendance/events/{event_id}",
                    "/api/v1/admin/locks",
                    "/api/v1/admin/shift-plan",
                    "/api/v1/admin/day-status",
                    "/api/v1/admin/shift-plan/selection",
                    "/api/v1/admin/employment-groups",
                    "/api/v1/admin/employment-groups/{group_id}",
                    "/api/v1/admin/employment-groups/{group_id}/members",
                    "/api/v1/admin/export",
                    "/api/v1/admin/smtp",
