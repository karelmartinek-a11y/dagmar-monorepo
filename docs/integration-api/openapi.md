...
`GET /api/v1/integration/openapi.json` vyžaduje bearer s `openapi:read` a podléhá samostatnému OpenAPI rate-limit bucketu. Pole `info.version` odpovídá `DAGMAR_INTEGRATION_CONTRACT_VERSION`, aktuálně `2026-09-01`.
